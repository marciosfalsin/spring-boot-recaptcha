...
public class RecaptchaController {
    ...
    private static final String RECAPTCHA_JS = "http://localhost:8080/scripts/recaptcha/api2/recaptcha__en.js";
    ...
    public String anchor(HttpServletRequest request) {
        ...
        response = response.replace("https://www.gstatic.com/recaptcha/api2/v1566858990656/recaptcha__en.js", RECAPTCHA_JS);
        return response;
    }

    @GetMapping(value = "recaptcha/api2/webworker.js", produces = "text/javascript")
    public String webworker(HttpServletRequest request) {
        return "importScripts('" + RECAPTCHA_JS + "')";
    }
    ...
    public ResponseEntity<String> reload(@RequestParam MultiValueMap<String, String> body) {
        RestTemplate restTemplate = new RestTemplate();
